            ...
            if (t.containment == "document" || t.containment == "window")
                this.containment = [
                    ...
                    (t.containment == "document" ? 0 : e(window).scrollLeft()) +
                        e(
                            t.containment == "document" ? document : window
                        ).width() -
                        this.helperProportions.width -
                        this.margins.left,
    ...
    e.widget("ui.resizable", e.ui.mouse, {
            ...
            if (this.handles.constructor == String) {
                ...
                for (var i = 0; i < r.length; i++) {
                    ...
                    u.css({ zIndex: n.zIndex }),
                        "se" == s &&
                            u.addClass("ui-icon ui-icon-gripsmall-diagonal-se"),
        ...
        _proportionallyResize: function () {
            ...
            for (
                ...
                i.css({
                    ...
                    width:
                        n.width() - this.borderDif[1] - this.borderDif[3] || 0,
                });
            }
        },
            ...
            resize: function (t, n) {
                ...
                var h = Math.abs(
                        (r._helper
                            ...
                            : r.offset.left - l.left) + r.sizeDiff.width
                    ),
                    p = Math.abs(
                        (r._helper
                            ? r.offset.top - l.top
                            : r.offset.top - o.top) + r.sizeDiff.height
                    ),
                    d = r.containerElement.get(0) == r.element.parent().get(0),
                    v = /relative|absolute/.test(
        ...
        e.ui.plugin.add("resizable", "ghost", {
            ...
            stop: function (t, n) {
                ...
                r.ghost &&
                    r.helper &&
                    r.helper.get(0).removeChild(r.ghost.get(0));
            },
        }),
                    ...
                    .each(function () {
                        ...
                        if (r) {
                            ...
                            return (
                                r.$element
                                    .removeClass(
                                        i ? "ui-unselecting" : "ui-selected"
                                    )
                                    .addClass(
                                        i ? "ui-selecting" : "ui-unselecting"
                                    ),
                                (r.unselecting = !i),
                                (r.selecting = i),
                                (r.selected = i),
        ...
        _createPlaceholder: function (t) {
            ...
            if (!n.placeholder || n.placeholder.constructor == String) {
                ...
                n.placeholder = {
                    element: function () {
                        var n = e(
                            document.createElement(t.currentItem[0].nodeName)
                        )
                            .addClass(
                                r ||
                            ...
                            i.width() ||
                                i.width(
                                    t.currentItem.innerWidth() -
                                        parseInt(
                                            t.currentItem.css("paddingLeft") ||
                                                0,
                                            10
                                        ) -
                                        parseInt(
                                            t.currentItem.css("paddingRight") ||
                                                0,
                                            10
                                        )
                                );
        ...
        _contactContainers: function (t) {
            ...
            for (var i = this.containers.length - 1; i >= 0; i--) {
                ...
                if (this._intersectsWith(this.containers[i].containerCache)) {
                    if (
                        n &&
                        e.contains(this.containers[i].element[0], n.element[0])
                    )
                        continue;
