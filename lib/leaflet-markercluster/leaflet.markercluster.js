...
(function () {
  (L.MarkerClusterGroup = L.FeatureGroup.extend({
    ...
    addLayer: function (t) {
      ...
      var n = t,
        r = this._map.getZoom();
      if (t.__parent) for (; n.__parent._zoom >= r; ) n = n.__parent;
      return (
      ...
      return this._map
        ? t.__parent
          ? (this._unspiderfy && (this._unspiderfy(), this._unspiderfyLayer(t)),
            ...
            t._icon &&
              (L.FeatureGroup.prototype.removeLayer.call(this, t),
              t.setOpacity(1)),
            this)
          : this
    ...
    addLayers: function (t) {
      var e, i, n;
      if (!this._map)
        return (this._needsClustering = this._needsClustering.concat(t)), this;
    ...
    removeLayers: function (t) {
      ...
      if (!this._map) {
        for (e = 0, i = t.length; i > e; e++)
          this._arraySplice(this._needsClustering, t[e]);
        return this;
      }
      for (e = 0, i = t.length; i > e; e++)
        (n = t[e]),
          n.__parent &&
            ...
            n._icon &&
              (L.FeatureGroup.prototype.removeLayer.call(this, n),
              n.setOpacity(1)));
      this._topClusterLevel._recursivelyAddChildrenToMap(
        null,
        this._zoom,
      ...
      for (e in this._layers)
        (n = this._layers[e]), n instanceof L.MarkerCluster && n._updateIcon();
      return this;
    },
    clearLayers: function () {
      ...
      for (var t in this._layers)
        L.FeatureGroup.prototype.removeLayer.call(this, this._layers[t]);
      return (
    ...
    zoomToShowLayer: function (t, e) {
      ...
      t._icon
        ...
        ? (this._map.on("moveend", i, this),
          t._icon || this._map.panTo(t.getLatLng()))
        : (this._map.on("moveend", i, this),
    ...
    onAdd: function (t) {
      ...
      for (
        ...
        (n = this._needsRemoving[e]), this._removeLayer(n);
      for (
        this._needsRemoving = [], e = 0, i = this._needsClustering.length;
        i > e;
        e++
      )
        (n = this._needsClustering[e]),
    ...
    onRemove: function (t) {
      ...
      for (var e in this._layers)
        L.FeatureGroup.prototype.removeLayer.call(this, this._layers[e]);
      this._map = null;
    },
    ...
    _removeLayer: function (t, e, i) {
      ...
      if (e)
        for (
          var o = this._maxZoom;
          o >= 0 && r[o].removeObject(t, s.project(t.getLatLng(), o));
          o--
        );
      var a,
        l = t.__parent,
        _ = l._markers;
      for (this._arraySplice(_, t); l && (l._childCount--, !(0 > l._zoom)); )
        e && 1 >= l._childCount
          ? ((a = l._markers[0] === t ? l._markers[1] : l._markers[0]),
            n[l._zoom].removeObject(l, s.project(l._cLatLng, l._zoom)),
            r[l._zoom].addObject(a, s.project(a.getLatLng(), l._zoom)),
            this._arraySplice(l.__parent._childClusters, l),
            l.__parent._markers.push(a),
            (a.__parent = l.__parent),
            l._icon &&
              (L.FeatureGroup.prototype.removeLayer.call(this, l),
              i || L.FeatureGroup.prototype.addLayer.call(this, a)))
          : (l._recalculateBounds(), (i && l._icon) || l._updateIcon()),
          (l = l.__parent);
      delete t.__parent;
    },
    _propagateEvent: function (t) {
      t.target instanceof L.MarkerCluster && (t.type = "cluster" + t.type),
        L.FeatureGroup.prototype._propagateEvent.call(this, t);
    },
          ...
          (this.on(
            ...
            function (i) {
              this._inZoomAnimation ||
                (t && e.removeLayer(t),
                i.layer.getChildCount() > 2 &&
                  i.layer !== this._spiderfied &&
                  ((t = new L.Polygon(
                    i.layer.getConvexHull(),
    ...
    _unbindEvents: function () {
      var t = this.options.spiderfyOnMaxZoom,
        ...
        n = this._map;
      (t || i) && this.off("clusterclick", null, this),
        e &&
          (this.off("clustermouseover", null, this),
          this.off("clustermouseout", null, this),
          n.off("zoomend", null, this),
          n.off("layerremove", null, this));
    },
    _zoomEnd: function () {
      this._map &&
    ...
    _generateInitialClusters: function () {
      ...
      for (var i = t; i >= 0; i--)
        (this._gridClusters[i] = new L.DistanceGrid(e)),
          (this._gridUnclustered[i] = new L.DistanceGrid(e));
        ...
        if ((o = s[e].getNearObject(i))) {
          ...
          for (n = e - 1; n > a._zoom; n--)
            (_ = new L.MarkerCluster(this, n, _)),
              r[n].addObject(_, this._map.project(o.getLatLng(), n));
          for (
            a._addChild(_), n = e;
            n >= 0 && s[n].removeObject(o, this._map.project(o.getLatLng(), n));
            n--
          );
          return;
        }
    ...
    _getExpandedVisibleBounds: function () {
      ...
      return new L.LatLngBounds(
        new L.LatLng(i.lat - r, i.lng - s, !0),
        new L.LatLng(n.lat + r, n.lng + s, !0)
      );
    },
    _animationAddLayerNonAnimated: function (t, e) {
      if (e === t) L.FeatureGroup.prototype.addLayer.call(this, t);
        ...
        L.FeatureGroup.prototype.removeLayer.call(this, i[0]),
          L.FeatureGroup.prototype.removeLayer.call(this, i[1]);
      } else e._updateIcon();
    },
  })),
      ...
      L.DomUtil.TRANSITION
        ? {
            ...
            _animationZoomIn: function (t, e) {
              ...
              this._topClusterLevel._recursively(r, t, 0, function (s) {
                ...
                for (
                  s._isSingleParent() && t + 1 === e
                    ? (L.FeatureGroup.prototype.removeLayer.call(n, s),
                      s._recursivelyAddChildrenToMap(null, e, r))
                    : (s.setOpacity(0),
                      s._recursivelyAddChildrenToMap(a, e, r)),
                    i = l.length - 1;
                  i >= 0;
                  i--
                )
                  (o = l[i]),
                    r.contains(o._latlng) ||
                      L.FeatureGroup.prototype.removeLayer.call(n, o);
              }),
                this._forceLayout();
              var s, o;
              ...
              for (s in n._layers)
                (o = n._layers[s]),
                  o instanceof L.MarkerCluster || !o._icon || o.setOpacity(1);
              n._topClusterLevel._recursively(r, t, e, function (t) {
                ...
                setTimeout(function () {
                  n._topClusterLevel._recursively(r, t, 0, function (t) {
                    L.FeatureGroup.prototype.removeLayer.call(n, t),
                      t.setOpacity(1);
                  }),
                    n._animationEnd();
                }, 200);
            ...
            _animationAddLayer: function (t, e) {
              var i = this;
              L.FeatureGroup.prototype.addLayer.call(this, t),
                e !== t &&
                  (e._childCount > 2
                    ? (e._updateIcon(),
                      this._forceLayout(),
                      ...
                      t.setOpacity(0),
                      setTimeout(function () {
                        L.FeatureGroup.prototype.removeLayer.call(i, t),
                          t.setOpacity(1),
                          i._animationEnd();
                      }, 200))
                    : (this._forceLayout(),
        ...
        this._recursively(
          ...
          function (t) {
            ...
            for (i = r.length - 1; i >= 0; i--)
              (n = r[i]), n._icon && (n._setPos(e), n.setOpacity(0));
          },
          function (t) {
            var i,
              n,
              ...
              for (var r = n._markers.length - 1; r >= 0; r--) {
                ...
                i.contains(s._latlng) &&
                  (t &&
                    ...
                    s.setOpacity(0)),
                  (s._noHas = !0),
                  L.FeatureGroup.prototype.addLayer.call(n._group, s),
                  delete s._noHas);
              }
          },
          function (e) {
            ...
            for (r = t._markers.length - 1; r >= 0; r--)
              (n = t._markers[r]),
                (i && i.contains(n._latlng)) ||
                  (L.FeatureGroup.prototype.removeLayer.call(t._group, n),
                  n.setOpacity(1));
          },
          function (t) {
            for (r = t._childClusters.length - 1; r >= 0; r--)
              (n = t._childClusters[r]),
                (i && i.contains(n._latlng)) ||
                  ((!L.FeatureGroup.prototype.hasLayer ||
                    L.FeatureGroup.prototype.hasLayer.call(t._group, n)) &&
                    L.FeatureGroup.prototype.removeLayer.call(t._group, n),
                  n.setOpacity(1));
          }
        );
      ...
      _recursively: function (t, e, i, n, r) {
        ...
        if (e > l)
          for (s = a.length - 1; s >= 0; s--)
            (o = a[s]),
              t.intersects(o._bounds) && o._recursively(t, e, i, n, r);
    ...
    (L.DistanceGrid.prototype = {
      ...
      removeObject: function (t, e) {
        var i,
          ...
          l = (a[r] = a[r] || []);
        for (
          delete this._objectPoint[L.Util.stamp(t)], i = 0, n = l.length;
          n > i;
          i++
        )
            ...
            for (i = _ - 1; _ + 1 >= i; i++)
              if ((s = r[i]))
                for (n = 0, o = s.length; o > n; n++)
                  (a = s[n]),
                    (l = this._sqDist(u[L.Util.stamp(a)], t)),
                    d > l && ((d = l), (p = a));
        return p;
      },
      ...
      L.QuickHull = {
        ...
        getConvexHull: function (t) {
          ...
          for (e = t.length - 1; e >= 0; e--) {
            var o = t[e];
            (i === !1 || o.lat > i) && ((r = o), (i = o.lat)),
              (n === !1 || n > o.lat) && ((s = o), (n = o.lat));
          }
          var a = [].concat(
    ...
    L.MarkerCluster.include({
      getConvexHull: function () {
        ...
        for (t = L.QuickHull.getConvexHull(r), i = t.length - 1; i >= 0; i--)
          s.push(t[i][0]);
        return s;
      },
    }),
        ...
        if (this._group._spiderfied !== this && !this._group._inZoomAnimation) {
          ...
          this._group._unspiderfy(),
            ...
            e.length >= this._circleSpiralSwitchover
              ...
              : ((r.y += 10), (t = this._generatePointsCircle(e.length, r))),
        ...
        ? {
            ...
            _animationSpiderfy: function (t, e) {
              ...
              for (i = t.length - 1; i >= 0; i--)
                (n = t[i]),
                  ...
                  n.setOpacity(0),
                  (n._noHas = !0),
                  L.FeatureGroup.prototype.addLayer.call(a, n),
                  delete n._noHas,
                  n._setPos(_);
              a._forceLayout(), a._animationStart();
              var h = L.Path.SVG ? 0 : 0.3,
                u = L.Path.SVG_NS;
              for (i = t.length - 1; i >= 0; i--)
                if (
                  ((s = l.layerPointToLatLng(e[i])),
                  (n = t[i]),
                  (n._preSpiderfyLatlng = n._latlng),
                  n.setLatLng(s),
                  n.setOpacity(1),
                  (r = new L.Polyline([o._latlng, s], {
                    weight: 1.5,
                    color: "#222",
                    opacity: h,
                  })),
                  ...
                  p.setAttribute("attributeName", "stroke-dashoffset"),
                    p.setAttribute("begin", "indefinite"),
                    p.setAttribute("from", d),
                    p.setAttribute("to", 0),
                    p.setAttribute("dur", 0.25),
                    r._path.appendChild(p),
                    p.beginElement(),
                    (p = document.createElementNS(u, "animate")),
                    p.setAttribute("attributeName", "stroke-opacity"),
                    p.setAttribute("attributeName", "stroke-opacity"),
                    p.setAttribute("begin", "indefinite"),
                    p.setAttribute("from", 0),
                    p.setAttribute("to", 0.5),
                    p.setAttribute("dur", 0.25),
                    r._path.appendChild(p),
                    p.beginElement();
                }
              if ((o.setOpacity(0.3), L.Path.SVG))
                for (this._group._forceLayout(), i = t.length - 1; i >= 0; i--)
                  (n = t[i]._spiderLeg),
                    (n.options.opacity = 0.5),
                    n._path.setAttribute("stroke-opacity", 0.5);
              setTimeout(function () {
            ...
            _animationUnspiderfy: function (t) {
              var e,
                ...
                s = r._map,
                o = t
                  ? s._latLngToNewLayerPoint(this._latlng, t.zoom, t.center)
                  : s.latLngToLayerPoint(this._latlng),
                a = this.getAllChildMarkers(),
                l = L.Path.SVG && this.SVG_ANIMATION;
              for (
                r._animationStart(), this.setOpacity(1), i = a.length - 1;
                i >= 0;
                i--
              )
                (e = a[i]),
              ...
              setTimeout(function () {
                ...
                for (i = a.length - 1; i >= 0; i--)
                  (e = a[i]), e._spiderLeg && t++;
                for (i = a.length - 1; i >= 0; i--)
                  (e = a[i]),
                    e._spiderLeg &&
                      (e.setOpacity(1),
                      e.setZIndexOffset(0),
                      t > 1 && L.FeatureGroup.prototype.removeLayer.call(r, e),
                      s.removeLayer(e._spiderLeg),
                      delete e._spiderLeg);
                r._animationEnd();
              }, 200);
            },
            ...
            _animationSpiderfy: function (t, e) {
              ...
              for (i = t.length - 1; i >= 0; i--)
                (s = a.layerPointToLatLng(e[i])),
                  ...
                  n.setLatLng(s),
                  n.setZIndexOffset(1e6),
                  L.FeatureGroup.prototype.addLayer.call(o, n),
                  (r = new L.Polyline([this._latlng, s], {
                    weight: 1.5,
                    color: "#222",
                  })),
                  a.addLayer(r),
